...
const mentionsLegalesContent = `
  ...
  Email : <a href="mailto:noah.emboule@outlook.com">noah.emboule@outlook.com</a></p>
  ...
  <p>L'ensemble du contenu de ce site (textes, images, éléments graphiques, logo, etc.) est la propriété exclusive de Noah Emboulé. Toute reproduction ou modification est interdite sans autorisation écrite préalable.</p>

  <h3>Crédits</h3>
  <p>Design et développement : Noah Emboulé</p>
`;
...
const politiqueConfidentialiteContent = `
  ...
  <p>Noah Emboulé n'est pas responsable des pratiques de confidentialité des sites externes.</p>

  <h3>Contact</h3>
  <p>Email : <a href="mailto:noah.emboule@outlook.com">noah.emboule@outlook.com</a></p>
`;
  ...
  if (mentionsLegales && politiqueConfidentialite && modal) {
    mentionsLegales.addEventListener('click', function(e) {
      ...
      document.getElementById('modal-body').innerHTML = `
        <p>Le site web noah-emboule.fr est édité par Noah Emboulé, UX Designer indépendant.</p>
        <p><strong>Contact :</strong> noah.emboule@outlook.com</p>
    ...
    politiqueConfidentialite.addEventListener('click', function(e) {
      ...
      document.getElementById('modal-body').innerHTML = `
        <p>Le site noah-emboule.fr respecte votre vie privée et s'engage à protéger les données personnelles que vous pourriez lui fournir.</p>
